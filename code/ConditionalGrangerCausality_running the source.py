...
filename = 'ALL VERBAL AND  NON VERBAL FOR 1st 30 MINS OF RGM_10secgranularity_other behaviors_g2_merging justification.csv'
print ("\nLoading behavioral signals from the csv file : ", filename,"\n")


x1 = InputCSV(filename, columns = ['p1_B1'])
x2 = InputCSV(filename, columns = ['p1_B2'])
x3 = InputCSV(filename, columns = ['p1_B3'])
...
x39 = InputCSV(filename, columns = ['p2_B1'])
x40 = InputCSV(filename, columns = ['p2_B2'])
x41 = InputCSV(filename, columns = ['p2_B3'])
...
x139 = InputCSV(filename, columns = ['CI_p1'])
x140 = InputCSV(filename, columns = ['CI_p2'])
